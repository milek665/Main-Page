...
<body>
    ...
    <div class="container">
        <div class="col text-right">
            ...
            <a href="snake.php?lang=polish"><img src="img/flags/pl.png" class="flags" alt="no pl"></a>
            <a href="snake.php?lang=english"><img src="img/flags/gb.png" class="flags" alt="no gb"></a>
            <a href="snake.php?lang=spanish"><img src="img/flags/es.png" class="flags" alt="no es"></a>
            <a href="snake.php?lang=deutsch"><img src="img/flags/de.png" class="flags" alt="no de"></a>
        </div>
        <div id="main">
            <div class="jumbotron">
